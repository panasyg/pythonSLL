from classes.web_service_app.commands import GetApiDataCommand, GetHistoryDataCommand, SaveDataToJsonFileCommand, SaveDataToTxtFileCommand
from classes.web_service_app.history.history import History
from classes.web_service_app.web_service_app_receiver import WebServiceAppReceiver
...
class WebServiceApp():
    ...
    def __init__(self):
        ...
        self.color = 'green'
        self.app_receiver = WebServiceAppReceiver()
