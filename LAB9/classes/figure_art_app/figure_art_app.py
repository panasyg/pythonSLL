...
from classes.figures.figures_3d.cube import Cube
from classes.figures.figures_2d.square import Square
...
class FigureArtApp(Figure):
    """
    class for generating figure art based on figure art class
    """
    def __init__(self):
        super().__init__()
        self.type = "cube"
