...
from client_application.commands import DisplayAllcharts, DisplayBarchart, DisplayLinechart, DisplayPiechart, SaveChartCommand
import pandas as pd


class ClientApplication():
    def __init__(self):
        self.data_source = 'lab8/data.csv'
