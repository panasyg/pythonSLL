from custom_text_art.custom_text_art import CustomTextArt
from custom_text_art_interface.helpers.helpers import text_file_saver


class CustomTextArtInterface:
    def __init__(self):
    ...
    def set_primary_data(self):
        ...
        width = int(input("art width: "))
        self.custom_text_art.set_width(width)
    ...
    def save_to_file(self):
        ...
        text_file_saver(filename, self.custom_text_art.generate_custom_text_art())
    ...
    def loop_menu(self):
        while True:
            ...
            if (menu_choice == 1):
                ...
                self.custom_text_art.set_width(new_width)
            elif (menu_choice == 5):
